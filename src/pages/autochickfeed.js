    ...
    return (
        <div>
            ...
            <div className='drop-shadow-md'>
                <div className='flex flex-col justify-center items-center py-7 pt-10 max-2xl:pt-5'>
                ...
                <div className='flex flex-col justify-between items-center max-w-[1300px] m-auto pb-20'> 
                    <div className='grid grid-cols-2 max-md:grid-cols-1 gap-8 px-16 items-center'>
                        <a target='_blank' rel='noreferrer' href='https://github.com/darienlabbe/Chicken-Feeder-Senior-Project'><ProjectImages src='autochickfeed.png'/></a>
                        <div>
                ...
                <div className='flex flex-col justify-center items-center pb-20 drop-shadow-md'>
                    ...
                    <div className='max-w-[1000px] max-xl:max-w-[800px] max-lg:max-w-[600px] max-md:max-w-[400px] max-sm:max-w-[270px]'>
                        <ul className='list-disc max-md:text-sm'>
                            ...
                            <li className='list-none py-5'><a target='_blank' rel='noreferrer' href='https://github.com/darienlabbe/Chicken-Feeder-Senior-Project/blob/main/Project%20Diagram.png'><img src='projectdiagram.png' className='hover:scale-105 duration-200 border-border-gray border-2 drop-shadow-lg rounded-md m-auto' loading='eager' alt='project diagram'/></a></li>
