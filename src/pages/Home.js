        ...
        <div>
            ...
            <section id='Title' className='flex max-md:flex-col justify-between items-center drop-shadow-md'>
                <div className='m-auto max-sm:ml-auto'>
                    <div className='ml-32 max-xl:ml-14 max-sm:ml-auto'>
                        ...
                        <div className='flex text-footer-color mt-10 max-md:mt-3'>
            ...
            <section id='Projects' className='py-10 drop-shadow-md'>
                <div className='flex flex-col justify-center items-center py-7 pt-16'>
                    ...
                    <p className='font-light tracking-wide mx-6 text-center text-text-color-dark'>Click on a project to learn more</p>
                </div>
            ...
            <section id='Skills' className='py-10 drop-shadow-md'>
                <div className='flex flex-col justify-center items-center pt-16'>
                    ...
                    <p className='font-light tracking-wide mx-6 text-center text-text-color-dark'>List of my skills I have developed over the years</p>
                </div>
                <div className='max-w-[1000px] m-auto grid grid-cols-3 max-lg:grid-cols-1 gap-2 px-16 grid-auto-rows-auto text-text-color-dark'>
                    ...
                    <div className='grid grid-rows-2 gap-2 h-full pt-5 max-lg:pt-0 max-lg:flex-col max-lg:flex'>
                        <div className='m-auto p-5 rounded-lg border-border-color-gray/10 border-2 border-opacity-10 drop-shadow-lg h-full w-[270px]'>
            ...
            <section id='About' className='py-10 drop-shadow-md'>
                ...
                <div className='flex space-x-8 mx-96 max-xl:mx-20 max-md:mx-10 max-md:flex-col pt-10 items-center'>
                    ...
                    <div className='grid grid-col-1'>
                        <h1 className='font-semibold max-md:pt-10 text-text-color-dark'>Hi I'm Darien</h1>
                        <p className='pt-2 text-text-color-dark'>I am a computer science major with experience in machine learning, full stack development, database management, graphics, . I have yet to narrow my focus onto 
            ...
            <section id='Contact' className='py-10 drop-shadow-md'>
                <div className='flex flex-col justify-center items-center pt-16'>
                    ...
                    <p className='font-light tracking-wide mx-6 text-center mb-16 text-text-color-dark'>Feel free to reach out</p>
            ...
            <section id='Footer' className='w-full mt-24 text-text-color-light bg-footer-color h-60 content-center'>
