            ...
            <div className='drop-shadow-md'>
                ...
                <div className='flex flex-col justify-between items-center max-w-[1300px] m-auto pb-20'> 
                    <div className='grid grid-cols-2 max-md:grid-cols-1 gap-8 px-16 items-center'>
                        <a target='_blank' rel='noreferrer' href='https://github.com/darienlabbe/CS-479/blob/main/MNIST_Data_CNN.ipynb' className='mb-20 max-md:mb-0'><ProjectImages src='mnist.png'/></a>
                        <div className='mb-20'>
                        ...
                        <a target='_blank' rel='noreferrer' href='https://github.com/darienlabbe/CS-479/tree/main/Facial_Recognition' className='mb-20 max-md:mb-0'><ProjectImages src='faces.png'/></a>
                        <div className='text-base max-md:text-sm'>
                        ...
                        <a target='_blank' rel='noreferrer' href='https://github.com/darienlabbe/CS-479/blob/main/Euro_Sat_Land_Use_Classification.ipynb' className='mb-20 max-md:mb-0'><ProjectImages src='eusat.png'/></a>
                        <div className='mb-20'>
                        ...
                        <a target='_blank' rel='noreferrer' href='https://github.com/darienlabbe/CS-479/tree/main/Natural15_Scene_Classification' className='mb-20 max-md:mb-0'><ProjectImages src='natscenes.png'/></a>
                        <div className='mb-20'>
                        ...
                        <a target='_blank' rel='noreferrer' href='https://github.com/darienlabbe/CS-479/tree/main/BioSoundSCape' className='mb-20 max-md:mb-0'><ProjectImages src='biosound.png'/></a>
                        <div>
