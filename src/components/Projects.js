        ...
        <div className='drop-shadow-md' id='Projects'>
            ...
            <div className='flex flex-col justify-between items-center max-w-[1000px] m-auto'>
                <div className='grid grid-cols-2 max-md:grid-cols-1 gap-5 px-16'>
                    ...
                    <button onClick={() => navigate("/website")}><img href='../pages/website.js' src='wormtitle.jpg' className='hover:scale-105 cursor-pointer border-gray-500 border-2 border-opacity-10 drop-shadow-lg duration-200 rounded-lg' alt='this website'/></button>
                </div>
            </div>
        </div>
    );
